...
local utils = table.concat({"alacritty", "atool", "git", "gnome-disk-utility", "gpart", "zip", "brightnessctl", "caja", "dosfstools", "engrampa", "evince", "fish", "fuzzel", "kitty", "man-db", "openvpn", "networkmanager-openvpn", "tlp", "wget", "waylock", "wayland-protocols"}, " ")
